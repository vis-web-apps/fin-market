...
REPLACE INTO feedback VALUES (1, 'Иван', '8-999-999-99-99', 'client1@mail.ru', 'Хотелось бы поделиться своим положительным
 опытом, касающимся вашей компании и предоставляемых финансовых услуг. Я считаю, что важно отметить ваше
превосходство в сфере клиентского обслуживания и качественного предоставления услуг.
Вначале, хотелось бы отметить вашу приветливость и профессионализм во время нашего взаимодействия. Ваши сотрудники
были дружелюбными, компетентными и готовыми помочь. Они проявляли высокий уровень знаний в финансовой отрасли,
отвечали на все мои вопросы и предлагали различные варианты решения, учитывая мои потребности.', true);
REPLACE INTO feedback VALUES (2, 'Павел', '8-999-888-88-88', 'client2@mail.ru', 'Я хотел бы отметить оперативность и
эффективность в обработке моих запросов. От создания моего аккаунта до решения финансовых вопросов, все
проходило гладко и без заминок. Я хотел бы выразить благодарность вашей команде за их проактивность и
готовность решать все возникающие проблемы оперативно.
Не менее важным аспектом вашей работы является прозрачность и доступность информации о предоставляемых услугах.
Я всегда был в курсе изменений, справок и различных предложений, что помогало мне принимать информированные
решения о моих финансовых вложениях.', true);
REPLACE INTO feedback VALUES (3, 'Николаев Николай', '8-999-777-77-77', 'client3@mail.ru', 'В целом, я доволен вашими финансовыми
услугами и благодарен за профессиональное обслуживание, которое я получил от вас. Я уверен, что ваша компания
будет продолжать развиваться и успешно работать на благо своих клиентов.', false);